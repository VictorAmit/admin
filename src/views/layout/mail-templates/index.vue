<template>
  <section class="card">
    ...
    <div class="card-body">
      <div class="row">
        <div class="col-lg-12">
          <h5 class="text-black"><strong>Simple Email</strong></h5>
          <p class="text-muted">Element: see source code</p>
          <div class="mb-5">
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; margin-bottom: 20px">
                  <tr>
                    <td style="vertical-align: top;">
                      <img src="resources/images/logo.png" alt="Clean UI Admin Template"
                           style="height: 40px"/>
                    </td>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tr>
                      <td>
                        ...
                        <p>This is a really simple email template. It's sole purpose is to get the recipient to click the
                ...
                <div style="text-align: center; font-size: 12px; color: #a09bb9; margin-top: 20px">
                  <p>
                    ...
                    Don't like these emails? <a href="javascript: void(0);"
                                                style="color: #a09bb9; text-decoration: underline;">Unsubscribe</a>
                    <br/>
                    Powered by Clean UI
                  </p>
                </div>
        ...
        <div class="col-lg-12">
          <h5 class="text-black"><strong>Email w/ Header</strong></h5>
          <p class="text-muted">Element: see source code</p>
          <div class="mb-5">
            <div width="100%" style="background: #eceff4; padding: 50px 20px; color: #514d6a;">
              <div style="max-width: 700px; margin: 0px auto; font-size: 14px">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tr>
                      <td>
                        ...
                        <p>Seems like you forgot your password for Clean UI. If this is true, click below to reset your
                          password.</p>
      ...
      <div class="row">
        <div class="col-lg-12">
          <h5 class="text-black"><strong>Ecommerce Email</strong></h5>
          <p class="text-muted">Element: see source code</p>
          <div class="mb-5">
            <div width="100%" style="background: #eceff4; padding: 50px 20px; color: #514d6a;">
              <div style="max-width: 700px; margin: 0px auto; font-size: 14px">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tr>
                      <td>
                        ...
                        <br/>
                        <br/>
                        <p style="text-align: center">Notice something wrong? <a href="javascript: void(0);" style="color: #01a8fe; text-decoration: underline;">Contact
                          our support team</a> and we'll e happy to help.</p>
                      </td>
                    </tr>
                    </tbody>
                  </table>
        ...
        <div class="col-lg-12">
          <h5 class="text-black"><strong>Email w/ Action</strong></h5>
          <p class="text-muted">Element: see source code</p>
          <div class="mb-5">
            <div width="100%" style="background: #eceff4; padding: 50px 20px; color: #514d6a;">
              <div style="max-width: 700px; margin: 0px auto; font-size: 14px">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; margin-bottom: 20px">
                  <tr>
                    <td style="vertical-align: top;">
                      <img src="resources/images/logo.png" alt="Clean UI Admin Template" style="height: 40px"/>
                    </td>
                    <td style="text-align: right; vertical-align: middle;">
                    <span style="color: #a09bb9;">
                      Some Description
                ...
                <div style="text-align: center; font-size: 12px; color: #a09bb9; margin-top: 20px">
                  <p>
                    Mediatec Software Inc., Abbey Road, San Francisco CA 94102
                    <br/>
                    Don't like these emails? <a href="javascript: void(0);" style="color: #a09bb9; text-decoration: underline;">Unsubscribe</a>
                    <br/>
                    Powered by Clean UI
                  </p>
                </div>
