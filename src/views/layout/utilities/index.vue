    ...
    <div class="card-header">
        <span class="utils__title">
            <strong>Utilities</strong>
                <a href="http://v4-alpha.getbootstrap.com/utilities/" target="_blank"
                   class="btn btn-sm btn-primary ml-2">Official Documentation <i class="icmn-link ml-1"></i></a>
        </span>
    </div>
    <div class="card-body">
        ...
        <div class="col-lg-6">
          <div class="mb-5">
            ...
            <table class="table table-hover">
              ...
              <tbody>
              <tr>
                <td class="text-nowrap"><code>.utils__link--underlined</code></td>
                <td><a href="javascript: void(0)" target="_blank" class="utils__link--underlined">Underlined Link</a></td>
              </tr>
              <tr>
                <td class="text-nowrap"><code>.utils__link--blue</code></td>
                <td><a href="javascript: void(0)" target="_blank" class="utils__link--blue">Blue Link</a></td>
              </tr>
              <tr>
                <td class="text-nowrap"><code>.utils__link--underlined.utils__link--blue</code></td>
                <td><a href="javascript: void(0)" target="_blank" class="utils__link--underlined utils__link--blue">Underlined
                  and Blue Link</a></td>
              </tr>
              </tbody>
            </table>
          ...
          <div class="mb-5">
            ...
            <div class="utils__example">
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="text-nowrap height-100" style="border:1px dashed #e6e8ea;overflow: hidden;">
