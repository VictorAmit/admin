  ...
  <div>
    ...
    <section class="card">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-8">
            <div class="w100 mb-4 px-3 py-2 bg-default text-white">.col-md-8</div>
          </div>
          <div class="col-md-4">
            <div class="w100 mb-4 px-3 py-2 bg-default text-white">.col-md-4</div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="w100 mb-4 px-3 py-2 bg-default text-white">.col-md-6</div>
          </div>
          <div class="col-md-6">
            <div class="w100 mb-4 px-3 py-2 bg-default text-white">.col-md-6</div>
          </div>
        ...
        <div class="row">
          <div class="col-md-1">
            <div class="w100 mb-4 px-3 py-2 bg-default text-white">.col-md-1</div>
          </div>
          <div class="col-md-1">
            <div class="w100 mb-4 px-3 py-2 bg-default text-white">.col-md-1</div>
          </div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-xs-12 col-md-8">
            <div class="w100 mb-4 px-3 py-2 bg-default text-white">
              .col-xs-12 .col-md-8
            </div>
          </div>
          <div class="col-xs-6 col-md-4">
            <div class="w100 mb-4 px-3 py-2 bg-default text-white">col-xs-6 .col-md-4</div>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-6 col-md-4">
